...
def mean_shift(inputfile, outputfile, sigma, min_edge, ratio):
    ...
    meanshift = cv.pyrMeanShiftFiltering(image, sp=8, sr=16, maxLevel=1,
                                         termcrit=(cv.TERM_CRITERIA_EPS + cv.TERM_CRITERIA_MAX_ITER, 5, 1))
...
if __name__ == "__main__":
    ...
    edge_map = cannyWatershed('1-039.jpg')
